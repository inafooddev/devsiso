...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/mobile/skb-rwo/history-value', [\App\Http\Controllers\Mobile\SkbRwo\IndexController::class, 'getHistoryValue'])->name('mobile.skb-rwo.history-value');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/call-plan/jks-summary', \App\Livewire\CallPlan\JksSummary\Index::class)->name('call-plan.jks-summary');
