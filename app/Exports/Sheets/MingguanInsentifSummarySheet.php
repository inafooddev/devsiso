...
use App\Services\MingguanInsentifCalculatorService;
use Carbon\Carbon;

class MingguanInsentifSummarySheet implements FromArray, WithEvents, WithTitle, WithCustomStartCell
{
    protected $rows = [];
    ...
    public function __construct($bulan, $region, $areas = [])
    {
        ...
        $service = new MingguanInsentifCalculatorService();
        $summaryData = collect();
