...
class ValidateSellOutJobV2 implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            if ($unmappedProducts > 0) {
                throw new \Exception("Ditemukan {$unmappedProducts} produk yang belum termapping. Proses dibatalkan.");
            }
            ...
            if ($unmappedSalesman > 0) {
                throw new \Exception("Ditemukan {$unmappedSalesman} salesman yang belum termapping. Proses dibatalkan.");
            }
            $batch->addLog('success', 'Semua salesman sudah termapping.');
            ...
            ProcessSellOutJobV2::dispatch($this->batchId, $this->filters, $totalRowsToProcess); // Kirim total baris ke job berikutnya
