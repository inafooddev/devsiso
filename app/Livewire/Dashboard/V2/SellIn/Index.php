...
namespace App\Livewire\Dashboard\V2\SellIn;
...
class Index extends Component
{
    ...
    public function mount()
    {
        ...
        $years = \Illuminate\Support\Facades\DB::table('v_sellin_per_cabang')
    ...
    {
        $baseQuery = \Illuminate\Support\Facades\DB::table('v_sellinvstarget')
            ->where('region', '!=', 'HOINA');
    ...
    private function getRawData()
    {
        ...
        return \Illuminate\Support\Facades\Cache::remember($cacheKey, now()->addHours(6), function() {
            ...
            $q = \Illuminate\Support\Facades\DB::table('v_sellinvstarget as vspc')
    ...
    public function render()
    {
        ...
        return view('livewire.dashboard.v2.sell-in.index', [
