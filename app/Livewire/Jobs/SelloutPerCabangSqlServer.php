...
class SelloutPerCabangSqlServer extends Component
{
    // Log Process
    public $batchId;
    public $logLines = [];
    ...
    public function startProcess()
    {
        ...
        ExtractSelloutPerCabangSqlServerJob::dispatch($batch->id);
    ...
    {
        return view('livewire.jobs.sellout-per-cabang-sqlserver')->layout('layouts.app');
    }
}
