...
class ZvSummaryTeamElite extends Component
{
    // Log Process
    public $batchId;
    public $logLines = [];
    ...
    public function startProcess()
    {
        ...
        $batch = ImportBatch::create([
            'file_name' => 'Proses ETL ZV Summary Team Elite',
            'status' => 'processing',
        ...
        ZvSummaryTeamEliteJob::dispatch($batch->id);
    }
    ...
    {
        return view('livewire.jobs.zv-summary-team-elite')->layout('layouts.app');
    }
}
