...
class SyncRptVisitAnH extends Component
{
    public $batchId;
    public $logLines = [];
    public $batchStatus;
    ...
    public function startProcess()
    {
        ...
        SyncRptVisitAnHJob::dispatch($batch->id);
    }
    ...
    {
        return view('livewire.jobs.sync-rpt-visit-an-h')->layout('layouts.app');
    }
}
