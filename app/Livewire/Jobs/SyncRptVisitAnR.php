...
class SyncRptVisitAnR extends Component
{
    public $batchId;
    public $logLines = [];
    public $batchStatus;
    ...
    public function startProcess()
    {
        ...
        SyncRptVisitAnRJob::dispatch($batch->id);
    }
    ...
    {
        return view('livewire.jobs.sync-rpt-visit-an-r')->layout('layouts.app');
    }
}
