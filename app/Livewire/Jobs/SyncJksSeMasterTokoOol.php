...
class SyncJksSeMasterTokoOol extends Component
{
    public $batchId;
    public $logLines = [];
    public $batchStatus;
    ...
    public function startProcess()
    {
        ...
        $batch = ImportBatch::create([
            'file_name' => 'Sync JKS SE Master Toko OOL',
            'status' => 'processing',
        ...
        SyncJksSeMasterTokoOolJob::dispatch($batch->id);
    }
    ...
    {
        return view('livewire.jobs.sync-jks-se-master-toko-ool')->layout('layouts.app');
    }
}
