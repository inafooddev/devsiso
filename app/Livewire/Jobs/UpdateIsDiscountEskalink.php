...
class UpdateIsDiscountEskalink extends Component
{
    public $batchId;
    public $logLines = [];
    public $batchStatus;
    ...
    public function startProcess()
    {
        ...
        $batch = ImportBatch::create([
            'file_name' => 'Update Is Discount Eskalink',
            'status' => 'processing',
        ...
        UpdateIsDiscountEskalinkJob::dispatch($batch->id);
    }
    ...
    {
        return view('livewire.jobs.update-is-discount-eskalink')->layout('layouts.app');
    }
}
