...
class SyncFsalesman extends Component
{
    public $batchId;
    public $logLines = [];
    public $batchStatus;
    ...
    public function startProcess()
    {
        ...
        SyncFsalesmanJob::dispatch($batch->id);
    }
    ...
    {
        return view('livewire.jobs.sync-fsalesman')->layout('layouts.app');
    }
}
