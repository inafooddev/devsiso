...
namespace App\Livewire\Eskalink\CustomerEska;
...
class Index extends Component
{
    ...
    protected string $menuRoute = 'customer-eska.index';
    ...
    public function mount()
    {
        ...
        if (session()->has('customer_eska_filters')) {
            $filters = session()->get('customer_eska_filters');
    ...
    public function resetFilters()
    {
        ...
        $this->areas = [];
        $this->distributors = [];
        session()->forget('customer_eska_filters');
    ...
    {
        session()->put('customer_eska_filters', [
    ...
    public function export()
    {
        ...
        \App\Helpers\ActivityLogger::log('Export Customer Eska', "Mengekspor data Customer Eska untuk distributor: {$this->distributorFilter}");
