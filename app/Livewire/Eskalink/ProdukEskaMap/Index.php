...
namespace App\Livewire\Eskalink\ProdukEskaMap;
...
class Index extends Component
{
    ...
    protected string $menuRoute = 'produk-eska-map.index';
    ...
    // Export Filters (Multi Select Products)
    ...
    public function mount()
    {
        ...
        if (session()->has('produk_eska_map_filters')) {
            $filters = session()->get('produk_eska_map_filters');
    ...
    public function resetFilters()
    {
        ...
        session()->forget('produk_eska_map_filters');
    ...
    {
        session()->put('produk_eska_map_filters', [
    ...
    public function render()
    {
        ...
        return view('livewire.eskalink.produk-eska-map.index', [
            'products' => $data
        ])->layout('layouts.app');
    }
}