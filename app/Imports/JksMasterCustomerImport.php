    ...
    public function collection(Collection $rows)
    {
        ...
        foreach ($rows as $row) {
            ...
            if ($validator->fails()) {
                ...
                $this->errorLogs[] = "Baris {$rowNumber} - Gagal validasi: {$errorMsg}";
                continue;
            }
            ...
            if (!$this->isAdmin && !in_array($distributorCode, $this->allowedDistributors)) {
                $this->errorLogs[] = "Baris {$rowNumber} - Akses ditolak: Anda tidak memiliki otoritas untuk Distributor Code '{$distributorCode}'.";
                continue;
            }
            ...
            try {
                ...
                $this->errorLogs[] = "Baris {$rowNumber} - Terjadi kesalahan sistem: " . $e->getMessage();
            }
        }
    }
}
