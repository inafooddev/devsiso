...
$groups = DB::table('access_group_menu')->where('menu_id', $parentId)->pluck('access_group_id');
foreach ($groups as $groupId) {
    DB::table('access_group_menu')->insert(['access_group_id' => $groupId, 'menu_id' => $menu->id]);
}
echo 'Menu Inserted with ID: ' . $menu->id . "\n";
