...
return new class extends Migration
{
    ...
    {
        Schema::create('insentif_mingguan_master_distributors', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['bulan', 'distributor_code'], 'unq_ins_mingguan_master_dist');
    ...
    {
        Schema::dropIfExists('insentif_mingguan_master_distributors');
    }
};
