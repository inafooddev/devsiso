...
return new class extends Migration
{
    ...
    {
        Schema::create('insentif_master_salesmans', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['bulan', 'distributor_code', 'sales_code'], 'unq_insentif_master_salesman');
    ...
    {
        Schema::dropIfExists('insentif_master_salesmans');
    }
};
