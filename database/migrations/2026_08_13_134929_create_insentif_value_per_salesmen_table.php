...
return new class extends Migration
{
    ...
    {
        Schema::create('insentif_value_per_salesmans', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['bulan', 'distributor_code', 'sales_code'], 'unq_insentif_val_salesman');
    ...
    {
        Schema::dropIfExists('insentif_value_per_salesmans');
    }
};
