...
export default function DetailModal({ data, onClose, showToast }) {
    ...
    const toko2Ref = useRef(null);
    const toko3Ref = useRef(null);
    ...
    const handleSubmit = (e) => {
        ...
        payload.append('distributor_code', data.distributor_code);
        
        // Append all text fields
        ['no_hp', 'nama_pemilik_toko', 'nik_ktp', 'nama_ktp', 'nama_bank', 'no_rekening', 'nama_pemilik_norek', 'latitude', 'longitude'].forEach(field => {
        ...
        router.post('/mobile/skb-rwo/submit-data', payload, {
            ...
            onSuccess: () => {
                ...
                setIsEditing(false);
                // Also trigger a refresh by calling onClose or relying on Inertia reload which happened automatically
            },
            onError: (errors) => {
                setIsSubmitting(false);
    ...
    return (
        <>
                                    ...
                                    <div>
                                        ...
                                        <select disabled={!!data.nama_bank} value={formData.nama_bank} onChange={e => handleTextChange('nama_bank', e.target.value)} className={getInputClass('nama_bank')}>
                                            ...
                                            <optgroup label="Bank Nasional (Himbara & Swasta)">
                                                ...
                                                <option value="Artha Graha">Artha Graha Internasional</option>
                                                <option value="Sinarmas">Bank Sinarmas</option>
                                                <option value="Maspion">Bank Maspion</option>
                                                <option value="Bumi Arta">Bank Bumi Arta</option>
                                                <option value="INA">Bank INA Perdana</option>
                                                <option value="Victoria">Bank Victoria</option>
                                                <option value="Index Selindo">Bank Index Selindo</option>
                                                <option value="Mestika">Bank Mestika Dharma</option>
                                            </optgroup>
                                            <optgroup label="Bank Syariah">
                                                ...
                                                <option value="Aladin Syariah">Bank Aladin Syariah</option>
                                            </optgroup>
                                            <optgroup label="Bank Digital">
                                                ...
                                                <option value="Raya">Bank Raya (Agro)</option>
                                            </optgroup>
                                            <optgroup label="Bank Pembangunan Daerah (BPD)">
                                                ...
                                                <option value="Nagari">Bank Nagari (Sumbar)</option>
                                                <option value="Riau Kepri">Bank Riau Kepri</option>
                                                <option value="Sumsel Babel">Bank Sumsel Babel</option>
            ...
            {/* Image Preview Modal inside DetailModal */}
            {previewImage && (
