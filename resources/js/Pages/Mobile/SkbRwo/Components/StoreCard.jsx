...
import {
    ...
    InformationCircleIcon, ClipboardDocumentCheckIcon, DocumentPlusIcon
} from '@heroicons/react/24/outline';
import { ShieldExclamationIcon } from '@heroicons/react/24/solid';

export default function StoreCard({ item, onOpenDetail, onOpenSkb, onOpenData }) {
    return (
        <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex flex-col gap-4 animate-fade-in relative overflow-hidden group">
            ...
            {(item.is_approved === 0 || item.is_approved === false) && (item.skb_reason || item.reason) ? (
