<div>
    ...
    <div class="mx-auto px-4 sm:px-6 py-8 text-base-content">
        ...
        <x-card flush title="Product Groups" icon="swatch" subtitle="Kelola grup produk berdasarkan unit brand untuk klasifikasi item" class="pb-6">
            <x-slot:actions>
                <div class="flex flex-wrap items-center gap-3">
                    <div class="relative group mr-2">
                        ...
                        <input wire:model.live.debounce.300ms="search" type="text" placeholder="Cari Group..." 
            ...
            {{-- Tabel Data --}}
            <x-ui.table loading="{{ false }}" empty="Tidak ada data product group ditemukan.">
                <x-slot:head>
                    <tr>
                        <th class="w-16">No</th>
                        <th>Kode Group</th>
                        <th>Nama Brand Unit</th>
                        <th>Dibuat Pada</th>
                ...
                @foreach ($groups as $index => $group)
                    <tr wire:key="group-{{ $group->product_group_id }}" class="group text-sm">
                        <td>
                            <span class="text-xs font-semibold text-base-content/40">{{ $groups->firstItem() + $index }}</span>
                        </td>
                        <td>
                            <span class="badge badge-sm badge-outline border-base-300 text-primary font-mono px-2 py-3 rounded-lg">{{ $group->product_group_id }}</span>
                        </td>
                        <td>
                            <span class="font-bold text-base-content/80 group-hover:text-primary transition-colors">{{ $group->brand_unit_name }}</span>
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="flex items-center justify-center gap-1">
                                ...
                                <button wire:click="confirmDelete('{{ $group->product_group_id }}')" 
