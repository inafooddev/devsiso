<div>
    <x-slot name="title">Data Categories</x-slot>
    ...
    <div class="mx-auto px-4 sm:px-6 py-8 text-base-content">
        ...
        <x-card flush title="Product Categories" icon="folder" subtitle="Kelola kategori produk untuk segmentasi dan pelaporan data" class="pb-6">
            <x-slot:actions>
            ...
            {{-- Tabel Data --}}
            <x-ui.table loading="{{ false }}" empty="Tidak ada data product category ditemukan.">
                <x-slot:head>
                    <tr>
                        <th class="w-16">No</th>
                        <th>Kode Kategori</th>
                ...
                @foreach ($categories as $index => $category)
                    <tr wire:key="category-{{ $category->category_id }}" class="group text-sm">
                        <td>
                            <span class="text-xs font-semibold text-base-content/40">{{ $categories->firstItem() + $index }}</span>
                        </td>
                        <td>
                            <span class="badge badge-sm badge-outline border-base-300 text-primary font-mono px-2 py-3 rounded-lg">{{ $category->category_id }}</span>
                        </td>
                        <td>
                            <span class="font-bold text-base-content/80 group-hover:text-primary transition-colors">{{ $category->category_name }}</span>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <div class="flex items-center justify-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                <button wire:click="openEditModal('{{ $category->category_id }}')" 
