<div>
    <x-slot name="title">Tambah Master Region</x-slot>

    <div class="container mx-auto p-4 sm:p-6 lg:p-8">
        <div class="max-w-xl mx-auto">
            <div class="bg-white shadow-xl rounded-2xl overflow-hidden">
                <div class="px-6 py-4 border-b bg-gray-50">
                    <h2 class="text-xl font-semibold text-gray-800">Tambah Region Baru</h2>
                </div>
                ...
                <form wire:submit.prevent="save">
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input wire:model.live="region_code" type="text" id="region_code" placeholder="Contoh: JABAR"
                        ...
                        <div>
                            ...
                            <input wire:model.live="region_name" type="text" id="region_name" placeholder="Contoh: Jawa Barat"
                    ...
                    <div class="bg-gray-50 px-6 py-4 flex justify-end items-center space-x-4 border-t">
                        ...
                        <button type="submit" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 active:bg-blue-900 focus:outline-none focus:border-blue-900 focus:ring ring-blue-300 disabled:opacity-25 transition ease-in-out duration-150 shadow-md hover:shadow-lg">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
