<div class="flex-1 flex flex-col w-full h-full min-h-0">
    <x-slot name="title">Jobs - Unmapping Customer Eska</x-slot>
        ...
        <div class="bg-base-100 rounded-xl shadow-xl border border-base-300 flex-1 min-h-0 min-w-0 flex flex-col overflow-hidden">
            ...
            <div class="p-3 md:p-4 lg:p-5 border-b border-base-300 shrink-0 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 bg-base-200/30">
                <div class="shrink-0 w-full lg:w-auto">
                    <h2 class="text-base md:text-lg font-bold">Pemrosesan Data Unmapping Customer Eska</h2>
                    <p class="text-[10px] md:text-xs text-base-content/60 font-semibold uppercase tracking-wider mt-0.5">Eksekusi SQL (Map, Dist, Prc) Berdasarkan Bulan</p>
                </div>

                <div class="flex flex-wrap items-center justify-start lg:justify-end gap-2 md:gap-3 w-full lg:w-auto">
                    <!-- Date Input -->
                    <div class="flex items-center gap-2">
                        <label for="month-picker" class="text-xs font-semibold text-base-content/70">Bulan:</label>
                        <input type="month" id="month-picker" wire:model="selectedMonth" 
                        ...
                        @if(empty($logLines))
                            <div class="flex flex-col items-center justify-center h-full text-slate-500 space-y-3">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-xs mt-1">Silakan tentukan bulan dan klik "Mulai Proses" untuk mengeksekusi script Unmapping Customer Eska.</p>
                                </div>
                            </div>
                        @else
