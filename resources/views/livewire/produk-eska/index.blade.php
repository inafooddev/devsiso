        ...
        <x-card flush title="Master Produk Eska" icon="cube" subtitle="Data master produk distributor yang telah terhubung dengan kode principal dan informasi kemasan" class="pb-6">
            ...
            @if (!$isFiltered)
                <div class="flex flex-col items-center justify-center py-20 text-base-content/40">
                    ...
                    <p class="text-sm text-center max-w-xs">Silakan tentukan wilayah distributor untuk melihat data master produk yang tersedia.</p>
                    <button wire:click="$set('isFilterModalOpen', true)"
        ...
        <div x-show="open"
            ...
            <div class="flex items-center justify-between px-6 py-5 border-b border-base-300 bg-base-200/30 rounded-t-3xl">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="font-bold text-lg leading-none">Filter Produk Eska</h3>
        ...
        <div x-show="open"
            ...
            <div class="flex items-center justify-between px-6 py-5 border-b border-base-300 bg-base-200/30 rounded-t-3xl">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="font-bold text-lg leading-none">Export Produk Eska</h3>
