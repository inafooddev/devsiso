<div>
    <x-slot name="title">Data Product Brands</x-slot>
    ...
    <div class="mx-auto px-4 sm:px-6 py-8 text-base-content">
        ...
        <x-card flush title="Product Brands" icon="tag" subtitle="Kelola merk produk untuk identitas dan pemasaran item" class="pb-6">
            <x-slot:actions>
                <div class="flex flex-wrap items-center gap-3">
                    <div class="relative group mr-2">
                        ...
                        <input wire:model.live.debounce.300ms="search" type="text" placeholder="Cari Brand..." 
            ...
            {{-- Tabel Data --}}
            <x-ui.table loading="{{ false }}" empty="Tidak ada data product brand ditemukan.">
                <x-slot:head>
                    <tr>
                        <th class="w-16">No</th>
                        <th>Kode Brand</th>
                        <th>Nama Product Brand</th>
                        <th>Dibuat Pada</th>
                ...
                @foreach ($brands as $index => $brand)
                    <tr wire:key="brand-{{ $brand->brand_id }}" class="group text-sm">
                        <td>
                            <span class="text-xs font-semibold text-base-content/40">{{ $brands->firstItem() + $index }}</span>
                        </td>
                        <td>
                            <span class="badge badge-sm badge-outline border-base-300 text-primary font-mono px-2 py-3 rounded-lg">{{ $brand->brand_id }}</span>
                        </td>
                        <td>
                            <span class="font-bold text-base-content/80 group-hover:text-primary transition-colors">{{ $brand->brand_name }}</span>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <div class="flex items-center justify-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                ...
                                <button wire:click="confirmDelete('{{ $brand->brand_id }}')" 
