    ...
    <div class="bg-base-100 rounded-xl shadow-xl border border-base-300 flex-1 min-h-0 min-w-0 flex flex-col overflow-hidden">
        ...
        <div class="p-3 md:p-4 lg:p-5 border-b border-base-300 shrink-0 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-base-200/30">
            <div class="shrink-0 w-full sm:w-auto">
                ...
                <p class="text-[10px] md:text-xs text-base-content/60 font-semibold uppercase tracking-wider mt-0.5">Informasi pemetaan produk distributor ke principal</p>
            </div>
            ...
            @else
                @if($products->isEmpty())
                    <div class="flex flex-col items-center justify-center py-20 text-base-content/40 absolute inset-0">
                        ...
                        <p class="text-sm text-center max-w-xs">Tidak ada data pemetaan produk yang ditemukan untuk kriteria filter ini.</p>
                    </div>
                @else
                                ...
                                <tr class="hover:bg-base-200/50 transition-colors group text-sm">
                                    ...
                                    <td class="bg-base-200/10">
                                        <div class="flex flex-col gap-1.5">
                                            ...
                                            <span class="font-semibold text-base-content/80 text-sm tracking-tight leading-tight whitespace-normal min-w-[200px]">{{ $row->product_name_dist }}</span>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <x-heroicon-s-link class="w-4 h-4 mx-auto text-base-content/10 group-hover:text-primary transition-colors" />
                                    </td>
                                    <td class="bg-primary/5 border-l border-base-300 shadow-[inset_1px_0_0_rgba(0,0,0,0.02)]">
                                        <div class="flex flex-col gap-1.5">
                                            <div class="badge badge-md bg-primary/10 border-primary/20 text-primary font-mono rounded-lg px-2.5">
                                                {{ $row->product_code_prc }}
                                            </div>
                                            <span class="font-semibold text-primary text-sm tracking-tight leading-tight whitespace-normal min-w-[200px]">{{ $row->product_name }}</span>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
