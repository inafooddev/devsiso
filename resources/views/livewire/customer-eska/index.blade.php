<div>
    ...
    <div class="mx-auto px-4 sm:px-6 py-8 text-base-content">
        ...
        <x-card flush title="Master Customer Eska" icon="identification" subtitle="Data master customer yang terintegrasi melalui Eskalink" class="pb-6">
            <x-slot:actions>
                ...
                <x-ui.table empty="Tidak ada data customer yang ditemukan untuk distributor ini.">
                    ...
                    @foreach ($customers as $row)
                        <tr class="group text-sm">
                            ...
                            <td><span class="font-mono text-base-content/70">{{ $row->kodecabang }}</span></td>
