<div>
    <x-slot name="title">Mapping Customer Eska</x-slot>
            ...
            <div class="overflow-x-auto">
                @if (!$isFiltered)
                    <div class="p-8 text-center text-gray-500">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Pilih Region, Area, dan Distributor untuk melihat mapping.
                        </p>
                        <button @click="showFilterModal = true"
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="px-6 py-10 text-center text-gray-500">
                                        <h3 class="text-sm font-medium text-gray-900">Tidak Ada Data Mapping</h3>
