<div>
    ...
    <div class="mx-auto px-4 sm:px-6 py-8 text-base-content">
        ...
        <x-card flush title="Mapping Customer Eska" icon="link" subtitle="Data pemetaan customer distributor ke customer principal melalui Eskalink" class="pb-6">
            <x-slot:actions>
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <div class="relative group">
                        ...
                        <input wire:model.live.debounce.500ms="search" type="text"
                               placeholder="Cari nama/no customer..."
            ...
            @else
                {{-- Tabel --}}
                <x-ui.table empty="Tidak ada data pemetaan customer yang ditemukan untuk distributor ini.">
                    <x-slot:head>
                        <tr>
