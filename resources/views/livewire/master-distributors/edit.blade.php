<div>
    <x-slot name="title">Edit Master Distributor</x-slot>
        ...
        <div class="bg-white shadow-xl rounded-2xl overflow-hidden">
            <form wire:submit.prevent="update">
                ...
                <div class="px-6 py-4 border-b bg-gray-50">
                    <h3 class="text-lg font-semibold text-gray-700">Formulir Edit Distributor</h3>
                </div>
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Distributor Code -->
                        <div>
                            <label for="distributor_code" class="block text-sm font-medium text-gray-700 mb-1">Kode Distributor</label>
                            <input type="text" wire:model.defer="distributor_code" id="distributor_code" class="w-full form-input border bg-gray-100 border-blue-300 shadow-sm p-1" disabled>
                        </div>
                        ...
                        <div class="md:col-span-2" x-data="{ open: false }" @click.away="open = false">
                            ...
                            <div class="relative">
                                ...
                                <div x-show="$wire.branch_code" class="w-full flex items-center justify-between form-input border bg-gray-100 border-blue-300 shadow-sm p-1">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="area_name" id="area_name" class="w-full form-input bg-gray-100 border border-blue-300 shadow-sm p-1" disabled>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" wire:model="supervisor_name" id="supervisor_name" class="w-full form-input bg-gray-100 border border-blue-300 shadow-sm p-1" disabled>
                        </div>
